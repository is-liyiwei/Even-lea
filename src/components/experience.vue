      ...
      list: [
        ...
        },
        {
          ...
          projectInfo: [
            ...
            `3、负责公司项目网页开发及维护、优化`,
            `4、根据产品设计，利用HTML5和CSS3等相关技术开发手机、平板电脑等多平台上的前端应用`,
            `5、负责微信小程序/微信公众号页面制作开发及维护`,
            `6、负责公司技术部框架的搭建使用`,
        ...
        },
        {
          ...
          projectInfo: [
            ...
            `6、<a onmouseover="window.openImgDialog(this, 'softbuilder')" onmouseleave="window.closeImgDialog(this)" target="view_window" class="reset-alink" href="https://www.softbuilder.cn">https://www.softbuilder.cn</a>`,
            ...
            `4、负责前端表现层与后端交互的设计和开发，保证页面浏览的兼容性和流畅浏览`,
