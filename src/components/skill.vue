  ...
  data() {
    return {
      ...
      skill: [
        ...
        { type: "js/jquery", percent: "90%" },
        { type: "css/css3", percent: "90%" },
        { type: "sass/less", percent: "70%" },
        { type: "bootstrap", percent: "80%" },
        { type: "vuejs", percent: "90%" },
        { type: "nodejs", percent: "60%" },
        { type: "expressjs", percent: "70%" },
        { type: "nestjs", percent: "60%" },
        { type: "mongoDB", percent: "60%" },
        { type: "git", percent: "60%" },
        { type: "typeScript", percent: "60%" },
      ]
    };
  },
  components: {
